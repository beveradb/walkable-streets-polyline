...
# Example: API_KEY = 'AIzaSyA-AXVLlwaiwfvzelb4LICoRtDTSqCanHQ'
API_KEY = 'YOUR_GOOGLE_MAPS_API_KEY'
# Backoff time sets how many minutes to wait between google pings when your API limit is hit
BACKOFF_TIME = 30
# Set your output file name here.
output_filename = 'data/batch-geocoder-output.csv'
# Set your input file here
input_filename = 'data/streets-from-osm-unique-nounknowncounty-within-20miles-of-78751.txt'
